    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-2 text-base text-gray-600 max-w-2xl">
          Welcome back, <span className="font-semibold text-gray-900">BuildRight Construction</span>. 
            ...
            <div className="flex items-center justify-between">
                ...
                {stat.trend === "up" && (
                    <span className="inline-flex items-baseline rounded-full bg-green-50 px-2.5 py-0.5 text-xs font-medium text-green-700 md:mt-2 lg:mt-0">
                        <TrendUp className="-ml-1 mr-0.5 h-3.5 w-3.5 flex-shrink-0 self-center text-green-500" weight="bold" />
                        Trending
                    </span>
                )}
            </div>
                            ...
                            <tbody className="divide-y divide-gray-200 bg-white">
                                {RECENT_PROJECTS.map((project) => (
                                    <tr key={project.name} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="whitespace-nowrap px-6 py-4">
                                            <span className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${project.statusColor}`}>
                                                {project.status}
                                            </span>
                                        </td>
            ...
            <div className="rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 p-6">
                ...
                <div className="space-y-3">
                    <button className="w-full group flex items-center justify-between rounded-lg border border-gray-200 p-4 text-left hover:border-blue-300 hover:ring-1 hover:ring-blue-300 transition-all bg-white hover:bg-blue-50/50">
                        <div>
                            <span className="block text-sm font-semibold text-gray-900 group-hover:text-blue-700">Create New Proposal</span>
                            <span className="block text-xs text-gray-500 mt-1">Submit a bid for a new project</span>
                        </div>
            ...
            {/* Notifications Placeholder */}
             <div className="rounded-xl bg-gradient-to-br from-blue-600 to-blue-700 p-6 text-white shadow-md">
                 ...
                 <p className="text-blue-100 text-sm mb-4">
                     All agencies must update their safety certification by next Monday.
                 </p>
